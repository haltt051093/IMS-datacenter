...
namespace IMS.Data.Repository
{
    public class LocationDAO : BaseDAO<Location>
    {
        ...
        public List<LocationViewModel> GetAllLocation(GetLocationQuery q = null)
        {
            ...
            var query = @"select l.LocationCode,ser.ServerCode,ser.DefaultIP, l.RackUnit, s.StatusName,r.RackName,r.RackCode, ser.Id,r.StatusCode as RackStatus, acc.Fullname, acc1.Fullname as ServerOwner, ser.Power, s1.StatusName as ServerStatus, ser.Bandwidth from Location as l
