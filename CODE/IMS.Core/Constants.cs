...
namespace IMS.Core
{
    public static class Constants
    {
        ...
        public class HtmlFormat
        {
            ...
            public const string FORM_LABEL_X3_CLASS = "col-xs-5 tf-form-label";
            public const string FORM_CONTROL_X3_CLASS = "col-xs-7 tf-form-control";
            public const string FORM_DETAIL_X3_CLASS = "col-xs-7 tf-form-control";
