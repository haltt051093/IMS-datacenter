...
{
    //Nguon tham khao: http://www.codeproject.com/Articles/2433/Flatten-that-Combobox
    public class PSSCCombobox : ComboBox
    {

        private Brush BorderBrush = new SolidBrush(SystemColors.Window);
        private Brush ArrowBrush = new SolidBrush(SystemColors.ControlText);
        private Brush DropButtonBrush = new SolidBrush(Color.Brown);
